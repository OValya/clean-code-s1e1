...
var incompleteTaskHolder=document.getElementById("list-tasks");
var completedTasksHolder=document.getElementById("list-completed-tasks");
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='list-item-task'
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #list-completed-tasks
    var listItem=this.parentNode;
